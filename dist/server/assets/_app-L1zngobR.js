import { r as reactExports, U as jsxRuntimeExports, _ as Outlet } from "./worker-entry-RQlX2Pcr.js";
...
import { L as ListTodo } from "./list-todo-CNhg2eL4.js";
import { U as Users } from "./users-hvqPoiOv.js";
import { T as Trophy } from "./trophy-D6Y-F5LD.js";
import { L as LogOut } from "./log-out-BsJelcvY.js";
import "node:events";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-30 border-b border-border bg-background/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-5xl items-center justify-between px-4 py-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { to: "/groups", icon: Users, label: "Groups" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { to: "/history", icon: History, label: "History" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { to: "/friends", icon: Users, label: "Friends" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { to: "/rooms", icon: Users2, label: "Rooms" }),
