...
const hrtime$3 = /* @__PURE__ */ Object.assign(function hrtime(startTime) {
  const now = Date.now();
...
const unenvProcess$2 = new Process({
...
const performance$2 = globalThis.performance && "addEventListener" in globalThis.performance ? globalThis.performance : new Performance();
...
const hrtime$2 = /* @__PURE__ */ Object.assign(function hrtime3(startTime) {
  const now = Date.now();
  const seconds = Math.trunc(now / 1e3);
  const nanos = now % 1e3 * 1e6;
  if (startTime) {
...
let ReadStream$1 = class ReadStream2 {
  fd;
  isRaw = false;
  isTTY = false;
  constructor(fd) {
...
let WriteStream$1 = class WriteStream2 {
  fd;
  columns = 80;
  rows = 24;
  isTTY = false;
...
let Process$1 = class Process2 extends EventEmitter {
  env;
  hrtime;
  nextTick;
  constructor(impl) {
...
let PerformanceEntry$1 = class PerformanceEntry2 {
  __unenv__ = true;
  detail;
  entryType = "event";
  name;
...
let PerformanceMeasure$1 = class PerformanceMeasure2 extends PerformanceEntry$1 {
  entryType = "measure";
};
let PerformanceResourceTiming$1 = class PerformanceResourceTiming2 extends PerformanceEntry$1 {
  entryType = "resource";
  serverTiming = [];
  connectEnd = 0;
  connectStart = 0;
...
let PerformanceObserverEntryList$1 = class PerformanceObserverEntryList2 {
  __unenv__ = true;
  getEntries() {
    return [];
  }
...
let Performance$1 = class Performance2 {
  __unenv__ = true;
...
let PerformanceObserver$1 = class PerformanceObserver2 {
  __unenv__ = true;
  static supportedEntryTypes = [];
  _callback = null;
  constructor(callback) {
...
const hrtime$1 = /* @__PURE__ */ Object.assign(function hrtime32(startTime) {
  const now = Date.now();
  const seconds = Math.trunc(now / 1e3);
  const nanos = now % 1e3 * 1e6;
  if (startTime) {
...
const unenvProcess = new Process22({
...
const performance = globalThis.performance && "addEventListener" in globalThis.performance ? globalThis.performance : new Performance22();
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-lhdKq8db-lhdKq8db-lhdKq8db.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CCG5AACC-CZ-yG0ZH-CEfRNWjS.js").then((n2) => n2.D),
    import("./start-HYkvq4Ni-HYkvq4Ni-HYkvq4Ni.js"),
    import("./__23tanstack-start-plugin-adapters-Cwee5PKy-Cwee5PKy-Cwee5PKy.js")
  ]);
  return {
    routerEntry,
    startEntry,
...
const workerEntry$1 = server_default ?? {};
const workerEntry$2 = workerEntry$1 ?? {};
const workerEntry = workerEntry$2 ?? {};
export {
  requireReact as $,
  findFlatMatch as A,
