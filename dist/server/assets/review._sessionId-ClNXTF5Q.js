import { U as jsxRuntimeExports, r as reactExports } from "./worker-entry-CbLWnQik.js";
import { c as Route, u as useAuth, a as useNavigate, s as supabase, t as toast } from "./router-B4_oxrh4.js";
import { b as buttonVariants, B as Button } from "./button-M6c_QbUe.js";
import { C as Card } from "./card-CbFnjLe4.js";
import { c as composeEventHandlers, a as createContextScope } from "./index-C-fQ04tc.js";
import { u as useComposedRefs } from "./index-CQE-ZmF3.js";
import { R as Root, c as createDialogScope, P as Portal, W as WarningProvider, C as Content, T as Title, D as Description, a as Close, O as Overlay, b as Trigger } from "./index-DA1u0bcF.js";
  ...
  reactExports.useEffect(() => {
    (async () => {
      const {
        data,
        error
      } = await supabase.from("study_sessions").select("task_title, duration_seconds, todo_id").eq("id", sessionId).single();
      if (error || !data) {
