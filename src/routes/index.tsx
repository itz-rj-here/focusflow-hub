...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "FocusFlow is a minimalist study timer with to-dos, session history, and a friendly global leaderboard." },
      { property: "og:title", content: "FocusFlow — Deep work made simple" },
      { property: "og:description", content: "Track focus sessions, complete tasks, climb the leaderboard." },
    ],
  }),
  component: Landing,
});
    ...
    <main className="bg-radial-glow min-h-screen">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-16 pt-16 text-center sm:pt-24">
        ...
        <h1 className="text-balance text-5xl font-semibold tracking-tight sm:text-6xl">
          Focus better.<br />
          <span className="bg-gradient-to-r from-primary to-primary-glow bg-clip-text text-transparent">Study smarter.</span>
        </h1>
        <p className="mx-auto mt-5 max-w-xl text-balance text-base text-muted-foreground sm:text-lg">
          A clean to-do list, a distraction-free focus timer, and a friendly leaderboard.
          Track every minute you put in — and watch the hours add up.
        </p>
      ...
      <section className="mx-auto grid max-w-5xl gap-4 px-6 pb-24 sm:grid-cols-3">
        {[
          { icon: ListChecks, title: "Plan your day", body: "Quick to-dos. Click one and start a focus session in a single tap." },
          { icon: Timer, title: "Enter flow", body: "A full-screen, distraction-free stopwatch. One task. One job." },
          { icon: BarChart3, title: "See progress", body: "Session history with charts. Watch your study hours climb." },
        ].map((f) => (
          <div key={f.title} className="rounded-2xl border border-border bg-card/60 p-5 backdrop-blur">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-24 text-center">
        ...
        <p className="mx-auto mt-2 max-w-lg text-sm text-muted-foreground">
          Public profiles appear on the global leaderboard. Switch to private anytime — your data stays hidden.
        </p>
